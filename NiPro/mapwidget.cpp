...
void MapWidget::agregarNuevaPieza(int pID,
                                  int pRow,
                                  int pCol)
{
    QRect square = QRect(pCol*Constantes::sizeSquare,
                         pRow*Constantes::sizeSquare,
                         Constantes::sizeSquare,
                         Constantes::sizeSquare);
    QPixmap pixmap = QPixmap(":/images/icons/set_0/fichas/pieza" + QString::number(pID) + ".png");
    pixmap = pixmap.scaled(QSize(Constantes::intIconSize*Constantes::FACTOR_CRECIMIENTO,
                                 Constantes::intIconSize*Constantes::FACTOR_CRECIMIENTO),
                           Qt::KeepAspectRatio, Qt::SmoothTransformation);
    QPoint location = QPoint (pCol*Constantes::sizeSquare,
                              pRow*Constantes::sizeSquare);
